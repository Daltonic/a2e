...
const QuestionTitle = ({ title, caption }) => {
  return (
    <div className="w-full sm:px-20 px-5 mt-4 flex justify-between items-center space-x-2">
      ...
      <button
        type="button"
        className="p-2 px-4 py-3 bg-blue-500 text-white font-medium rounded-md text-xs leading-tight capitalize hover:bg-blue-600 focus:outline-none focus:ring-0 transition duration-150 ease-in-out"
